...
if (btnFinalizarTest) {
    ...
    // ══════════════════════════════════════════════════════════
    // ABRIR TEST DEL EVALUADO DESDE EL PANEL ADMIN
    // ══════════════════════════════════════════════════════════

    const btnOpenTestEvaluado = document.getElementById("btn-open-test-evaluado");

    if (btnOpenTestEvaluado) {
        btnOpenTestEvaluado.addEventListener("click", function () {
